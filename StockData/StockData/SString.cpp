...
TCHAR afxChNil = '/0';
int _afxInitData[] = { -1, 0, 0, 0 }; //初始化SStringData的地址
SStringData* _afxDataNil = (SStringData*)&_afxInitData; //地址转化为SStringData*
LPCTSTR _afxPchNil = (LPCTSTR)(((BYTE*)&_afxInitData) + sizeof(SStringData));
const SString&  AfxGetEmptyString()  //建立一个空的SString
{
