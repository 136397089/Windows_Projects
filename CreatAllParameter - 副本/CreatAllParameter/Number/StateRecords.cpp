...
// //输入数据，进行单日局部分析
// //////////////////////////////////////////////////////////////////////////
// // void StateRecords::DailyLocalStateRecord(
...
// //对最终的数据进行趋势判断
// //////////////////////////////////////////////////////////////////////////
// bool StateRecords::GetFinalTrend(
...
// //
// //////////////////////////////////////////////////////////////////////////
// bool StateRecords::ChckeAllPointer(
// 	const StockDataPointer& pointers)
// {
// 	if ( 
...
// 	const string& day)
// {
// 	LocalStatePoints _vGenreMinIndex;
// 	LocalStatePoints _vGenreMaxIndex;
...
// 	LocalStatePoints::reverse_iterator closelyMinIte = _vGenreMinIndex.rbegin();
// 	LocalStatePoints::reverse_iterator closelyMaxIte = _vGenreMaxIndex.rbegin();
// 
// 	vector<tySData> vMindiff;
// 	vector<tySData> vMaxdiff;
// 	for (LocalStatePoints::reverse_iterator ite = closelyMinIte + 1; ite != _vGenreMinIndex.rbegin(); ++ite)
// 	{
// 		vMindiff.push_back(closelyMinIte->_Value - ite->_Value);
// 		if (vMindiff.size() == _TrAnaBeginSize / 2)//只需要对最近的四个局部特征点做分析
// 			break;
// 	}
// 	for (LocalStatePoints::reverse_iterator ite = closelyMaxIte + 1; ite != _vGenreMaxIndex.rbegin(); ++ite)
// 	{
...
// //
// //////////////////////////////////////////////////////////////////////////
// void StateRecords::DailyStateRecord(
...
// 		{
// 			string info;
// 			LocalStatePoints::const_reverse_iterator endIte = tempIndex.rbegin();
// 			unsigned int i = 0;
...
// }
// 
// // bool StateRecords::GetLocalIndex(
// // 	const IndexGenre& valueType, 
// // 	LocalStatePoints& _ReturnIndex)
// // {
// // 	_ReturnIndex.clear();
// // 	for (LocalStatePoints::const_iterator ite = _vIndexRecord_Local.begin();
